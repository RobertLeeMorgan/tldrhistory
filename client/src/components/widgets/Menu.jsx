...
export default function Menu({widgetDisplay, handleClick, handleSort, handleOpen}) {
    return (
        <div className="menu fixed z-50 top-28 right-0 lg:right-2 xl:top-20 xl:right-4 2xl:right-6 2xl:top-28 w-max">
